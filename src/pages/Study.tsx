    ...
    <div className="min-h-screen flex flex-col bg-[#fff6e5]">
      ...
      <main className="container mx-auto px-4 sm:px-8 py-8 sm:py-12 flex-grow">
        <div className="text-center mb-8 sm:mb-12">
          <div className="inline-block -rotate-2 p-4 sm:p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] border-4 border-black mb-6 bg-[#9b87f5]">
            <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-white relative rotate-2">
              Study Center
            </h1>
          </div>
            ...
            <TabsContent value="flashcard" className="mt-0">
                <Card className="border-4 border-black bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
                  <Tabs value={flashcardSubTab} onValueChange={handleFlashcardSubTabChange} className="p-0">
                    ...
                    <TabsContent value="view" className="p-6 sm:p-8">
                      {flashcardContext.activeDeck ? (
                        <FlashcardViewer />
                      ) : (
                        <div className="text-center py-8 sm:py-16">
                          <p className="text-xl sm:text-2xl font-bold px-6 py-4 bg-[#E5DEFF] inline-block border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
