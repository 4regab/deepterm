...
export async function GET() {
    ...
    const lines = [
        ...
        '## Features',
        '',
        '- [AI Flashcard Generator](' + baseUrl + '/dashboard): Transform any study material into smart flashcards',
        '- [Practice Tests](' + baseUrl + '/practice): AI-generated quizzes from your materials',
        '- [Pomodoro Timer](' + baseUrl + '/pomodoro): Built-in focus timer with study tracking',
        '- [Study Analytics](' + baseUrl + '/dashboard): Track your progress and streaks',
        '',
        '## About',
        '',
