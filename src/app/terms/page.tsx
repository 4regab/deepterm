...
export default function TermsPage() {
  return (
    <div className="bg-background min-h-screen">
      ...
      {/* Content */}
      <main id="main-content" className="px-4 sm:px-6 py-10 sm:py-14 lg:py-16 max-w-[65ch] mx-auto">
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="space-y-8 font-sans text-[14px] sm:text-[15px] text-foreground/80 leading-[1.7]">
            <section>
              <h2 className="font-sans tracking-tight text-[18px] sm:text-[20px] text-foreground mb-3">1. Acceptance of Terms</h2>
              <p>
            ...
            <section>
              <h2 className="font-sans tracking-tight text-[18px] sm:text-[20px] text-foreground mb-3">2. Description of Service</h2>
              <p>
            ...
            <section>
              <h2 className="font-sans tracking-tight text-[18px] sm:text-[20px] text-foreground mb-3">3. User Accounts</h2>
              <p>
            ...
            <section>
              <h2 className="font-sans tracking-tight text-[18px] sm:text-[20px] text-foreground mb-3">4. Acceptable Use</h2>
            ...
            <section>
              <h2 className="font-sans tracking-tight text-[18px] sm:text-[20px] text-foreground mb-3">5. Intellectual Property</h2>
              <p>
            ...
            <section>
              <h2 className="font-sans tracking-tight text-[18px] sm:text-[20px] text-foreground mb-3">6. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="font-sans tracking-tight text-[18px] sm:text-[20px] text-foreground mb-3">7. Analytics and Tracking</h2>
              <p className="mb-3">
              ...
              <p className="mt-3">
                ...
                <Link href="/privacy-policy" className="text-foreground underline hover:no-underline">
                  Privacy Policy
                </Link>.
              </p>
            </section>
            ...
            <section>
              <h2 className="font-sans tracking-tight text-[18px] sm:text-[20px] text-foreground mb-3">8. Changes to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="font-sans tracking-tight text-[18px] sm:text-[20px] text-foreground mb-3">9. Contact</h2>
              <p>
